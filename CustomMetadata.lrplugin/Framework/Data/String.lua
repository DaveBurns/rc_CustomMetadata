...
--
--  @usage      *** deprecated - use pluralize instead - screw the "word instead of number" stuff (more trouble than worth),
--              <br>    and pluralize supports singular phrase, not just singular word.
--
...
--- Make plural phrase from singular.
--
--  <p>Could be enhanced to force case of singular explicitly, instead of just adaptive.</p>
--
--  @param      count       Actual number of things.
