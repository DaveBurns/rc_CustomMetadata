...
_G.Object = require( 'System/Object' )
_G.ObjectFactory = require( 'System/ObjectFactory' )
_G.InitFramework = require( 'System/InitFramework' )
_G.SpecialObjectFactory = require( 'SpecialObjectFactory' )
_G.objectFactory = SpecialObjectFactory:new()
_G.init = InitFramework:new() -- create initializer object.
init:framework()
...
Object.register( 'ExtendedExportFilter' )
_G.Preferences = require( 'System/Preferences' )
_G.XmlRpc = require( 'Communication/XmlRpc' )
_G.SpecialManager = require( 'SpecialManager' )
--_G.SpecialExport = require( 'SpecialExport' )
_G.ExtendedUpdater = require( 'ExtendedUpdater' )
_G.Groups = require( 'Groups' )
_G.groups = Groups:new()
_G.timeOfDisablePrompt = 0 -- keeps disable prompt from appearing twice in rapid succession.
_G.timeOfEnablePrompt = 0 -- keeps enable prompt from appearing twice in rapid succession.
...
SpecialManager.initPrefs()
app:initDone()
-- no async-init/bg in this plugin
